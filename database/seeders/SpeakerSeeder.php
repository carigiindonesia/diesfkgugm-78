...
class SpeakerSeeder extends Seeder
{
    public function run(): void
    {
        $speakers = [
            ...
            ['slug' => 'pribadi-santosa', 'name' => 'drg. Pribadi Santosa, M.S., Sp.KG, Subsp.KR(K)', 'title' => 'Konservasi Gigi', 'topic' => 'Secrets of Successful Class II Restorations (Disponsori oleh Revoden Asia)', 'section' => 'scientific', 'initials' => 'PS', 'sort_order' => 4],
